...
/**
 * TNZ specific report generator subclass redefining report path locations
 * @author jnramsay
 */
public class TNZReportGenerator extends ReportGenerator {

	private static Logger jlog = Logger.getLogger("com.alcatel_lucent.nz.wnmsreport.TNZReportGenerator");
	...
	//public TNZDatabase db;

	/* regenerate current batch of reports */
	//public boolean regenerate;

	/**
	 * Constructor for TNZ report generator defining paths, db type and dateformats
	 */
	public TNZReportGenerator(){
		super();
		jlog.info("TRG: Init");
		this.db = new TNZDatabase();
