...
/**
 * TNZDatabase. TNZ specific database implementation. Primarily used for its init()
 * function where paramaters are set. open/close/execute all just wrap a connector instance
 * @author jnramsay
 *
 */
public class TNZDatabase implements ALUDatabase {
	 ...
	 * @param s
	 * @return resultset from arbitrary query input
	 */
