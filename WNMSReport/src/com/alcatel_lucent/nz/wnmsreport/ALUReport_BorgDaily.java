...
public class ALUReport_BorgDaily extends ALUReport {

	public ALUReport_BorgDaily(){
	}

	public String getName(){
		return "rncap_borgdaily";
	}
	...
	public List<ALUReport> getSubReport() {
		...
		rl.add(new ALUReport_BorgDaily_occupancy());
		rl.add(new ALUReport_BorgDaily_data());
		return rl;
	}
