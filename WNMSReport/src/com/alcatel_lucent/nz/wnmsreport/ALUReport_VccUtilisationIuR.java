...
public class ALUReport_VccUtilisationIuR extends ALUReport {
	
	public ALUReport_VccUtilisationIuR(){
		/*
	...
	public List<ALUReport> getSubReport() {
		...
		rl.add(new ALUReport_VccUtilisationIuR_table());
		//rl.add(new ALUReport_VccUtilisationIuRCP_chart());		
		rl.add(new ALUReport_VccUtilisationIuR_chart());
		//rl.add(new ALUReport_VccUtilisationIuR_bchart());
		return rl;
	}
