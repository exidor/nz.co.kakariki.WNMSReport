...
public class ALUReport_RncAp extends ALUReport {
	
	public ALUReport_RncAp(){
	}
	...
	public List<ALUReport> getSubReport() {
		...
		rl.add(new ALUReport_RncAp_occupancy());
		rl.add(new ALUReport_RncAp_data());
		rl.add(new ALUReport_RncAp_balance());
		return rl;
	}
