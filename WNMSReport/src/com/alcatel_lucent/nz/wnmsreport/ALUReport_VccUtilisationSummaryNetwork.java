...
public class ALUReport_VccUtilisationSummaryNetwork extends ALUReport {
	
	public ALUReport_VccUtilisationSummaryNetwork(){
		/*
	...
	public String getName(){
		return "vccutilisation_networksummary";
	}
	
	@Override
	public String getDisplayName(){
		return "VCC Network Summary";
	}
	...
	public List<ALUReport> getSubReport() {
		...
		rl.add(new ALUReport_VccUtilisationSummaryNetwork_chart());
		return rl;
	}
	...
	public void setImagePath(String path) {
		...
		params.put("network", this.path+"network.png");	
	}
