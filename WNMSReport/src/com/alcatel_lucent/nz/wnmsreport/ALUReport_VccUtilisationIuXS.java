...
public class ALUReport_VccUtilisationIuXS extends ALUReport {
	
	public ALUReport_VccUtilisationIuXS(){
		/*
	...
	public List<ALUReport> getSubReport() {
		...
		rl.add(new ALUReport_VccUtilisationIuXS_table());		
		rl.add(new ALUReport_VccUtilisationIuXS_chart());
		return rl;
	}
