...
public class ALUReport_VccUtilisationSummaryNetwork_chart extends ALUReport {
	
	public ALUReport_VccUtilisationSummaryNetwork_chart(){
	}

	public String getName(){
		return "vccutilisation_networksummarychart";
	}
